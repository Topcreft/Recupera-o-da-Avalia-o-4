...
HTML
 ...
 O HTML podemos representar como o esqueleto de um site. Ele é a linguagem que usamos para dar a forma e a estrutura básica a tudo o que você vê na web. Em vez de escrevermos um texto simples e sem graça, usamos "tags" para dizer ao navegador: "Olha, esta parte aqui é um título, esta outra é um parágrafo, e esta é uma imagem".
...
A Barbearia do Alura fo montado o texto do conteudo e de forma limpa e separarada e com a informação destacada junto com a mudança de cor de fundo adicinamento de imagem, minturado com a montagem do login do cliente, estruturação de tabela, formulario, localização e promove o que a barbearia tras de bom para os cliente gerando comforto e tufoi feito em ordem para que o funcinamento adequado.
